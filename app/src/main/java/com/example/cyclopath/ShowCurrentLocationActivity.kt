...
import com.example.cyclopath.databinding.ActivityShowCurrentLocationBinding
...
class ShowCurrentLocationActivity : AppCompatActivity() {
     ...
     */
    private lateinit var binding: ActivityShowCurrentLocationBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityShowCurrentLocationBinding.inflate(layoutInflater)
