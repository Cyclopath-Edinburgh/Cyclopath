...
//        }
        ...
        if (ContextCompat.checkSelfPermission(this@LocationTrackingActivity,
                        Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED
                &&
                ContextCompat.checkSelfPermission(this@LocationTrackingActivity,
        ...
        LocationEngineProvider.getBestLocationEngine(applicationContext).getLastLocation(object : LocationEngineCallback<LocationEngineResult> {
...
//                        println(mapboxNavigation.cancelRouteRequest())
    ...
    open fun askForLocationPermissions() {
        println("aaaaaskfor")
        if (ActivityCompat.shouldShowRequestPermissionRationale(this@LocationTrackingActivity,
                        Manifest.permission.ACCESS_FINE_LOCATION)) {
            AlertDialog.Builder(this)
                    .setTitle("Location permessions needed")
                    .setMessage("you need to allow this permission!")
                    .setPositiveButton("Sure") { dialog, which ->
                        ActivityCompat.requestPermissions(this@LocationTrackingActivity, arrayOf(Manifest.permission.ACCESS_FINE_LOCATION),
            ...
            ActivityCompat.requestPermissions(this@LocationTrackingActivity, arrayOf(Manifest.permission.ACCESS_COARSE_LOCATION),
                    Cyclopath.LOCATION_PERMISSION_REQUEST_CODE)
        }
...
//
////        mapView.getMapboxMap().loca
//
////        locationEngine = LostLocationEngine(this@MainActivity)
////        locationEngine.setPriority(LocationEnginePriority.HIGH_ACCURACY)
////        locationEngine.setInterval(5000)
////        locationEngine.activate()
////        val lastLocation: Location = locationEngine.getLastLocation()
////        locationPermissionHelper = LocationPermissionHelper(WeakReference(this))
////        locationPermissionHelper.checkPermissions {
////            onMapReady()
////        }
