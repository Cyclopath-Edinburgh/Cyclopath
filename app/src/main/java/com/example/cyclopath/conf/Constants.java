...
import com.example.cyclopath.util.Bearing;
...
public class Constants {
   ...
   /** server url */
   public static final String SERVER_URL = CONFIG_TEMPLATE.SERVER_URL;
   ...
   public static final String MARKET_DETAILS = 
      "market://details?id=com.example.cyclopath";
   ...
   public static String BITLY_LOGIN = CONFIG_TEMPLATE.BITLY_LOGIN;
   /** api key for making bit.ly requests*/
   public static String BITLY_APIKEY = CONFIG_TEMPLATE.BITLY_APIKEY;
   ...
   /** Debugging */
   public static final boolean DEBUG = CONFIG_TEMPLATE.DEBUG;
