...
public class LoginActivity2 extends BaseActivity
   ...
   public void login(String username, String password) {
      System.out.println(isNetworkAvailable(LoginActivity2.this));
      ...
      docRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
         ...
         public void onComplete(@NonNull Task<DocumentSnapshot> task) {
            if (task.isSuccessful()) {
               ...
               if (document.exists()) {
                  Toast.makeText(LoginActivity2.this, "Successfully login!", Toast.LENGTH_SHORT).show();
               } else {
                  ...
                  db.collection("users").document(username)
                          ...
                          .addOnSuccessListener(new OnSuccessListener<Void>() {
                             ...
                             public void onSuccess(Void aVoid) {
                                Toast.makeText(LoginActivity2.this, "Successfully sign up!", Toast.LENGTH_SHORT).show();
