...
import com.example.cyclopath.databinding.ActivitySearchRouteBinding
...
class SearchRouteActivity : AppCompatActivity() {
     ...
     */
    private val binding: ActivitySearchRouteBinding by lazy {
        ActivitySearchRouteBinding.inflate(layoutInflater)
    }
