...
import com.example.cyclopath.gwis.GWIS_Geocode;
import com.example.cyclopath.gwis.GWIS_GeocodeCallback;
import com.example.cyclopath.gwis.GWIS_RouteGetCallback;
import com.example.cyclopath.gwis.GWIS_RouteGetNew;
import com.example.cyclopath.items.Route;
import com.example.cyclopath.util.Address;
...
public class FindRouteActivity extends BaseActivity
   ...
   public void onCreate(Bundle savedInstanceState) {
      ...
      if (map.size() > Constants.MAX_AUTOCOMPLETE_ADDRESSES) {
         ...
         ArrayList<Entry<String,?>> list =
            new ArrayList<Entry<String,?>>(map.entrySet());
         ...
         Editor editor = G.autocomplete.edit();
